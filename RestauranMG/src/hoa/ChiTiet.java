...
public class ChiTiet extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        button1.setBorderColor(new java.awt.Color(0, 153, 153));
        ...
        button2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/IMG/delete.png"))); // NOI18N
        button2.setText("Xóa");
        button2.setBorderColor(new java.awt.Color(0, 153, 153));
        button2.setRadius(30);

        button3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/IMG/download.png"))); // NOI18N
        button3.setText("Lưu");
        button3.setBorderColor(new java.awt.Color(0, 153, 153));
