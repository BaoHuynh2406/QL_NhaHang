...
public class Search extends JTextField {
    ...
    public Search() {
        ...
        iconSearch = new ImageIcon(getClass().getResource("/IMG/search.png"));
        iconClose = new ImageIcon(getClass().getResource("/IMG/close.png"));
        iconLoading = new ImageIcon(getClass().getResource("/IMG/loading.gif"));
