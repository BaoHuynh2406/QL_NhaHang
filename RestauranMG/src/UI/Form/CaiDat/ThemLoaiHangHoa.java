...
public class ThemLoaiHangHoa extends javax.swing.JDialog {

    DefaultTableModel model;

    public ThemLoaiHangHoa(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    ProductCategoriesDao mDao = new ProductCategoriesDao();

    public void fill() {

        model.setRowCount(0);
        List<ProductCategories> l = mDao.selectAll();
        for (ProductCategories e : l) {
    ...
    public void Save() {
        for (int i = 0; i < tbl.getRowCount(); i++) {
            ProductCategories m = new ProductCategories();
            try {
                m.setID_Categories((int) tbl.getValueAt(i, 0));
            } catch (Exception e) {
                m.setID_Categories(0);
            }

            m.setCategoryName((String) tbl.getValueAt(i, 1));

            if (m.getID_Categories() != 0) {
                mDao.update(m);
            } else {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ThemLoaiHangHoa.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ThemLoaiHangHoa dialog = new ThemLoaiHangHoa(new javax.swing.JFrame(), true);
